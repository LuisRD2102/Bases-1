    ...
    <div class="container">
        ...
        <main>
            ...
            <div class="content">
                ...
                <div class="tabla-inmueble" id="tablaInmueble">
                ...
                <div class="form-poliza">
                    ...
                    <div class="wrapper">
                        ...
                        <form class="form" method="post">
                          <h1 class="titleHogar">Contrata Hogar</h1>
                          ...
                          <input type="hidden" id="cedulasBeneficiarios" name="campoInmuebles">
                        ...
                        if (conectar()){
                            if (!empty($_POST["campoTitulares"])){
                                contratoInmueble($_POST["campoTitulares"],$_POST["campoInmuebles"],$_POST["id_agente"],date('Y/m/d h:i:s a', time()),'Activo',31,23,44,"NULL");
                            }
                        }
                        ?>
                ...
                <h2>Lista de Personas</h2>
                    ...
                    <div class="buscadorDiv">  
                        ...
                        <div class="der">
                            ...
                            <button class="btnBeneficiario" id="btnAbrirPopUp2"><span class="material-icons-sharp">person_add</span><h4>Agregar Inmueble</h4></button>
                ...
                <div class="derecha-vida">
                    <h2>Lista de Inmuebles</h2>
                        ...
                        <div class="buscadorDiv">  
                                ...
                                <div class="der">
                                    <button class="btnTitular2" onclick="agregarInmueble()" id="btnTitular"><span class="material-icons-sharp">add_task</span><h4>Inmueble</h4></button>
                                    <span class="material-icons-sharp">search</span>
                                    <input type="text" id ="buscarHogar" class="buscador" placeholder="             ID..." onkeyup="buscarHogar()">
                                </div>

                        </div>                          

                                <table class="content-table" id="tablaInmueble">
                                        <thead>
                                            <tr>                                                   
                                                <th>ID</th>
                                                <th>Valor</th> 
                                                <th>Riesgos Auxiliares</th>                                                   
                                            </tr>
                                        </thead>
                    ...
                    <!---------------------------------------------------->
                        ...
                        <div class="wrapperPop">
                            <form class="form" method="post" id="formPopUp2">
                                ...
                                <h1 class="titlePopHogar">Registrar Inmueble</h1>

                                <div class="inputContainer">
                                    <input type="number" class="inputPop" placeholder="a"  name="valor" required>
                                    <label for="" class="label">Valor</label>
                                </div> 

                                <div class="inputContainer">
                                    <input type="text" class="inputPop" placeholder="a"  name="riesgos" required>
                                    <label for="" class="label">Riesgos Auxiliares</label>
                                </div> 

                                <div class="inputContainerTxt">
                                        <textarea class="inputPopTextArea" name="direccion" rows="4" cols="50" placeholder="a" required></textarea>
                                         <label for="" class="label">Dirección</label>
                                </div>

                                <div class="inputContainerTxt">
                                        <textarea class="inputPopTextArea" name="contenido" rows="4" cols="50" placeholder="a" required></textarea>
                        ...
                        <?php
                                if (isset($_POST["valor"],$_POST["riesgos"],$_POST["direccion"],$_POST["contenido"])
                                && !empty($_POST["valor"]) && !empty($_POST["riesgos"]) && !empty($_POST["direccion"]) && !empty($_POST["contenido"])){
                                        $id = generarId("inmueble","id_inmueble");
                                        registrarInmueble($id,$_POST["direccion"],$_POST["valor"],$_POST["contenido"],$_POST["riesgos"]);
